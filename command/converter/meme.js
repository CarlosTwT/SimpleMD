...
module.exports = {
  ...
  alias: ["meme","smeme"],
  category: "converter",
  desc: "Crear imagen de meme para etiqueta",
  async run({msg, conn},{q}){
    ...
    text = q;
    if(!text)return reply(`Formato erróneo!!\nEjemplo : .${cmdNya} text|txt`)
    ...
    try {
      if (isQStic) {
        ...
        msg.reply(`Formato erróneo!!\nEjemplo : .${cmdNya} trxt|trxt\nResponde imagen/ stiker`)
      }
    } catch (e){
